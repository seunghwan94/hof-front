...
function LoginForm() {
  ...
  const handleGoogleLogin = () => {
    // window.open("https://hof.lshwan.com/oauth2/authorization/google", "_self");
    window.open("http://localhost:8080/api/v1/oauth2/authorization/google", "_self");
  };
    ...
    <form onSubmit={handleSubmit}>
      <div>
        ...
        >
          ...
          <div className="mt-4">
            <button 
              className="btn btn-outline-hof w-100 mt-2" 
